...
public class ScreenConfigData extends GuiData {
	...
	public void sendTo(net.minecraft.world.level.Level world, net.minecraft.core.BlockPos pos) {
		WDNetworkRegistry.sendToNear(world, pos, new S2CMessageOpenGui(this));
	}
